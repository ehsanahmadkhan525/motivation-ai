...
async def main():
	...
	ground_task = (
		'You are a professional job finder. '
		'1. Read my cv with read_cv'
		'find AI jobs in and save them to a file'
	...
	# model = ChatOpenAI(model="gemini-1.5-flash", api_key=os.getenv("GEMINI_API_KEY"), base_url="https://generativelanguage.googleapis.com/v1beta/openai/")
	agents = []
	for task in tasks:
